...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText Name,Password,Phone,ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            { if(TextUtils.isEmpty(Name.getText().toString()))
                ...
                {
                Toast.makeText(RegisterActivity.this, "Please enter your ID first", Toast.LENGTH_SHORT).show();
                ...
                }  else
                {
                    mref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(!(dataSnapshot.child("Users").child("+63"+Phone.getText().toString()).exists()))
                            {
                                CreateAccount(Phone,Name,Password,ID);
                            }
                            else
                            {
    ...
    private void CreateAccount(EditText phone, EditText name, EditText password, EditText ID) {
        Map<String,Object> details=new HashMap<String,Object>();
        details.put("Phone","+63"+phone.getText().toString());
        details.put("Name",name.getText().toString());
        details.put("Password",password.getText().toString());
        details.put("Vote","0");
        details.put("Party","");
        details.put("ID", ID.getText().toString());
        mref.child("Users").child("+63"+phone.getText().toString()).updateChildren(details)
