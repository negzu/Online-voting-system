...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myphone="+63"+Phone.getText().toString();
    ...
    private void AllowAccessToUser(final String myphone, final String mypassword) {
        ...
        mref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    final Users userdata=dataSnapshot.child("Users").child("+63"+Phone.getText().toString()).getValue(Users.class);
                    if(userdata.getPhone().equals("+63"+Phone.getText().toString()))
                    {
                        ...
                        if(userdata.getPassword().equals(Password.getText().toString()))
                        {
                            ...
                            i.putExtra("phone","+63"+Phone.getText().toString());
                            startActivity(i);
                        }
                        else
                        {
